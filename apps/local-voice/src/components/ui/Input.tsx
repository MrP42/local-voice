...
/// forwardRef, weil ein Suchfeld fokussiert werden muss. Ohne das griffen
/// zwei Stellen im Projekt zum rohen <input> zurueck — die Luecke im
/// Baustein war die Ursache, nicht Nachlaessigkeit an der Aufrufstelle.
